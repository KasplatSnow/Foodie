...
insert into review (review_text, rating, userID, restaurantID)
values ("Jumbo Servings! Hole-in-the-wall Japanese dining out of the blue on Almaden Rd, south end of Willow Glen. You don't believe what you are reading? Go check out their Udon dish.. It's too big for one!", 5.0, 3, 2);
...
insert into review (review_text, rating, userID, restaurantID)
values ("amazing burgers, nice staff, quick service, 10/10 recommend!! spectacular vibes!! i go everyday", 5.0, 3, 3);
